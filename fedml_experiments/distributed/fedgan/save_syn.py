...
if __name__ == '__main__':
    ...
    dataloader = create_dataset(args, channel, 1)  # create a dataset given opt.dataset_mode and other options
    ...
    folder_name = f"{args.dataset}_{args.netG}_epoch{args.epoch}"
